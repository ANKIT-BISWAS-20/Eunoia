...
function ProfileBar({isMember,image,userData,setReload}) {
    ...
    <div className='w-full bg-transparent flex justify-end sm:justify-between p-2 items-center'>
      ...
      <div className='flex gap-6 '>
        <div className='mr-2 mt-2'>
          {isMember && <Chip color="success" variant="flat">Member Dashboard</Chip>}
          {!isMember && <Chip color="danger" variant="flat">Leader Dashboard</Chip>}
        </div>
        <div className='mr-2'>
        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <Profile isMember={isMember} userData={userData} setReload={setReload} />
              </ModalBody>
              <ModalFooter>
