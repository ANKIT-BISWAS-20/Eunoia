...
function Profile({ isMember, userData }) {
        ...
        <div>
            ...
            <div className='flex gap-4 justify-center'>
                ...
                <div className='flex-col space-y-10 py-4'>
                    <div>
                        {isMember ? <Chip color="success" variant='flat' size='xl'>Member</Chip> : <Chip color="danger" variant='flat' size='xl'>Leader</Chip>}
                    </div>
            ...
            <div className='mt-12'>
                <Table hideHeader aria-label="Example static collection table">
                    ...
                    <TableBody>
                        ...
                        <TableRow key="7">
                            <TableCell><Chip color="primary">Experties</Chip></TableCell>
