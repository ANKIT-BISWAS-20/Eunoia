      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <Link to="/login" className="rounded-md bg-yellow-default text-black px-3.5 py-2.5 text-lg font-semibold  shadow-sm hover:bg-yellow-dark mr-8 w-1/6 flex justify-center ">
              Log in
            </Link>
          </div>
        </nav>
        <Dialog className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white-default px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div className="lg:w-1/2 text-left">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center lg:justify-start">
              <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-blue-dark ring-1 ring-gray-900/20 hover:ring-gray-900/30">
                With smart collaboration system.{" "}
            ...
            <div className="text-center lg:text-left">
              ...
              Revolutionize your learning experience with our cutting-edge virtual learning and collboration platform Euonia. Dive into interactive collaboration rooms, stay organized with personalized dashboards, and learn together with like-minded people who help you to grow and thrive.
              </p>
