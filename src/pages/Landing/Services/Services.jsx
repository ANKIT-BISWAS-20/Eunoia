...
const links = [
    { name: 'Signup As Team Member to Explore Features For Members ' },
    { name: 'Signup As Team Leader to Explore Features For Leaders' },
   
  ]
  const stats = [
    { name: 'Unified platform for managing projects, tasks, and team assignments', value: 'Centralized Workspace' },
    { name: 'Smart recommendations for task allocation and roadmap generation', value: 'AI-Driven Task Prioritization' },
    { name: 'Real-time and efficient interaction between team members and stakeholders', value: 'Seamless Communication' },
    { name: 'Instant analytics on team performance, task progress, and project efficiency', value: 'Real-Time Insights' },       
  ]
