...
function LeaderDashboardMain() {
  ...
  return (
    <div className="flex flex-col bg-grey-default h-screen overflow-hidden">
        ...
        <ProfileBar isMember={false} image={avatar} userData={data?.data} />
          <Outlet />
        </div>
      </div>
  )
...
export default LeaderDashboardMain


export const leaderInfoLoader = async () => {
  try {
