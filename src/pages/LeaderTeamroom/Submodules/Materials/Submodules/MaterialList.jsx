...
export default function MaterialList({ teamMaterials }) {
  ...
  const deleteMaterial = async (e) => {
    ...
    try {
      ...
      const response = await axios.delete(`${Backend_url}/api/v1/materials/delete-material?teamId=${teamId}&materialId=${selectedMaterial}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`
        }
      });
