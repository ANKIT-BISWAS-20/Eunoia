  ...
  const giveFeedback = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${Backend_url}/api/v1/materials/give-material-feedback?materialId=${selectedMaterial}`, {
        understandability: collaboration,
                          ...
                          key === "feedback" && (
                            <div>
                              ...
                              <div className="flex gap-4">
                                <Typography variant="h6" className="text-lg font-bold">Communication
                                </Typography>
                                <Rating
                                  size="large"
                              ...
                              <div className="flex gap-4 mb-4">
                                <Typography variant="h6" className="text-lg font-bold">Accountability</Typography>
                                <Rating
                                  size="large"
                                  name="simple-controlled"
