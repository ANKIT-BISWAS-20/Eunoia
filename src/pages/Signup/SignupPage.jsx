    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto  lg:py-0 ">
                ...
                <Link
                    to="/"
                    className="absolute top-8 left-8 rounded-md bg-blue-default text-white-default px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
                >
                    Back
                </Link>
                    ...
                    <div className="p-16 space-y-4 md:space-y-6 sm:p-16 ">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className='space-y-4 sm:space-y-0 sm:flex sm:gap-4'>
                                ...
                                >
                                    <SelectItem key="member" color="primary">
                                        Team Member
                                    </SelectItem>
                                    <SelectItem key="leader" color="primary">
                                        Team Leader
                                    </SelectItem>
                                </Select>
                            ...
                            {formData.role.target?.value === 'member' && (<div className='space-y-4 sm:space-y-0 sm:flex sm:gap-4'>
                                <Select
                                    label="Semester"
                                    color="primary"
                                    className="w-full"
